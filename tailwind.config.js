  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        foreground: "var(--color-foreground)", /* near-black slate */
        primary: {
        ...
        popover: {
          ...
          foreground: "var(--color-popover-foreground)", /* near-black slate */
        },
        card: {
          DEFAULT: "var(--color-card)", /* pure white */
          foreground: "var(--color-card-foreground)", /* near-black slate */
        },
        success: {
          DEFAULT: "var(--color-success)", /* professional emerald green */
